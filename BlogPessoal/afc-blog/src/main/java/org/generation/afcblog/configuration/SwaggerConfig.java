package org.generation.afcblog.configuration;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("org.generation.afcblog.controller"))
	...
	private static Contact contact() {
		return new Contact("Ana Flavia", "https://github.com/afc-me", "anaflaviacamelorc@gmail.com");
	}
